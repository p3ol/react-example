...
class Premium extends React.Component
    ...
    render: ->
        ...
        if @state.go_to_subscribe
            return `(
                <Redirect to="/subscribe" push={true} />
            )`
        ...
        `(
            <div className="page premium">
                <div className="container">
                    ...
                    { !window.test_user.premium ? <div id="poool-widget"></div> : "" }
                </div>
            </div>
        )`

    componentWillUnmount: ->
        poool "unevent", "onSubscribeClick", @onSubscribe
